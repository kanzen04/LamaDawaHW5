...
import Path_X.PathX.SortingHatPropertyType;
import Path_X.data.SortingHatLevelRecord;
import Path_X.data.PathXDataModel;
import Path_X.data.SortingHatRecord;
import Path_X.ui.PathXMiniGame;
import properties_manager.PropertiesManager;
import static Path_X.PathXConstants.*;
import Path_X.data.SnakeCell;
import Path_X.data.SortingHatAlgorithm;
import Path_X.data.SortingHatAlgorithmFactory;
import Path_X.data.SortingHatAlgorithmType;
